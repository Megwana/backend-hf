...
- Won't Have  
   - Poll posts (a future feature to grow the website). I had developed the model for this in this [repository](https://github.com/Megwana/hotfeet-backend/tree/main/backend/polls) but did not have time to implement the front end react code.
